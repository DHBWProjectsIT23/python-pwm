...
class TestCryptoAES(unittest.TestCase):
    def test_aes_256_encrypt(self):
        ...
        """
        testString = "Dies ist ein geheimer Text mit AES."
        key = b'3)\x0e\xb7QX\x94R\x84\x1a\xa4K\xef\xd4\xc6>\x99v\x0ez~+\xd9+:\xaa*\x04G\xa3M\xd7'
        ciphertext = aes.encrypt_aes(testString, key)
        expected_ct = b'\xce:\x9f\x07\xd89\xb1p \xfc\xc3\xe0KbKx\xe1{.\xb5\x08\xa9\x06\x8b=\x91f\x96v\x8a43\xebf\xf5\x0by\xd5\x1b\x025\xaaW\xebW\x83\xdb*\xcc\xff>I\xc4\x8a\x9a\xd8\x83\x15\xa6Hh\x8b;g'
