...
class PasswordInformationDict(TypedDict):
    ...
    Args:
        ...
        categories (NotRequired[list[str]]): A list of categories or tags for the password (optional).
        note (NotRequired[str]): Additional notes about the password (optional).
        created_at (NotRequired[float]): The timestamp when the password information was created (optional).
        last_modified (NotRequired[float]): The timestamp when the password information was last modified (optional).
    """
